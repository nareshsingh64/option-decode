import { ResetPasswordFormShell } from "../forgot-password/password-forms";
    ...
    <main className="relative grid min-h-screen overflow-hidden bg-slate-950 text-white lg:grid-cols-[minmax(0,1fr)_minmax(24rem,30rem)]">
      ...
      <section className="relative z-10 flex min-h-screen flex-col justify-between px-5 py-5 sm:px-7 lg:px-10">
        ...
        <div className="max-w-2xl py-12">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-emerald-300">Protected password reset</p>
          <h1 className="mt-5 text-5xl font-semibold leading-[1.04] text-white sm:text-6xl">Create a New Password</h1>
          <p className="mt-5 max-w-xl text-lg leading-8 text-slate-200">Use the reset link from your email to update access to your Option Decode workspace.</p>
        </div>
